...
function Project(){
    ...
    <div className="grid grid-cols-[auto-fit, minmax(205px, 1fr)] sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 justify-items-center items-center justify-center p-4 ">
            ...
            {projectData.map((p, index) => (<div className="group relative bg-[hsla(0,0%,10%,0.5)] w-full max-w-[450px]  aspect-[4/3]  rounded-t-[28px] rounded-b-[16px] z-2 selected-project hover:scale-[1.05] hover:rounded-b-[0px] hover:z-10 duration-500 m-5" key={index}>
