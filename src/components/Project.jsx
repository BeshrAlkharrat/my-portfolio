...
function Project(){
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 justify-items-center items-center bg-amber-950">
            ...
            {projectData.map((p, index) => (<div className="group relative bg-[hsla(0,0%,10%,0.5)] w-[375px] h-[325px] rounded-t-[28px] rounded-b-[16px] z-2 selected-project hover:scale-[1.5] hover:rounded-b-[0px] hover:z-10 duration-500" key={index}>
